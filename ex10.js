var equacio = prompt("Introdueix una equació de segon grau:");
        //console.log("HOLA :)");
...
if(dis<0){
    ...
    document.getElementById('Equation').innerHTML=" Equation = " + a + "x&#178; + " + b + "x + " + c + "<br />"; document.getElementById('x1').innerHTML=' Alpha (x1) = ' + x1;
    document.getElementById('x2').innerHTML=' Beta (x2) = ' + x2;
}
var resultat = eval(sentencia) ;
alert(resultat);
